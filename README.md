...
- 🌱 **主要方向**：Rust 编程语言
- 🌿 **业余爱好**：Java 开发
- 🤝 **所属组织**：[Moon-Spirit](https://github.com/Moon-Spirit)
- 📍 **所在地**：中国

## 📁 精选仓库

### Yueling 聊天软件
由 Moon-Spirit 组织开发的聊天应用。
- 🔗 [GitHub 仓库](https://github.com/Moon-Spirit/Yueling)
- 📚 **技术栈**：Rust, WebSocket
- 🎯 **功能**：实时聊天、消息加密、多用户支持

### CatSeedLogin-rust
CatSeedLogin 的 Rust 实现版本，提供安全的登录认证功能。
- 🔗 [GitHub 仓库](https://github.com/Moon-Spirit/CatSeedLogin-rust)
- 📚 **技术栈**：Rust
- 🎯 **功能**：用户认证、密码加密、会话管理
...
- 🔧 [GitHub 个人主页](https://github.com/sanjiu2024)
...
⭐️ 来自 [sanjiu2024](https://github.com/sanjiu2024)
